...
REM
REM Generated by Vivado on Fri Mar 21 10:30:50 -0300 2025
...
echo "xvlog --incr --relax -prj fir_param_tb_vlog.prj"
call xvlog  --incr --relax -prj fir_param_tb_vlog.prj -log xvlog.log
